...
const Search_Destination_Times = () => {
    ...
    const check_coordinates_Dest = async () => {
        ...
        const latitude_dest = await AsyncStorage.getItem("latitude_dest_lat_Time");
        const longitude_dest = await AsyncStorage.getItem("latitude_dest_lng_Time");
        const area_destination = await AsyncStorage.getItem("data_description_dest_Time");
    ...
    const address_dest = async (data, details) => {
        ...
        await AsyncStorage.setItem('latitude_dest_lat_Time', latitude.toString());
        await AsyncStorage.setItem('latitude_dest_lng_Time', longitude.toString());
        await AsyncStorage.setItem('data_description_dest_Time', area_here.toString());
        navigation.goBack()
...
export default Search_Destination_Times
